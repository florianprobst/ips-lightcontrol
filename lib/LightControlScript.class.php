<?
/**
* LightControl Script class
*
* This configures light control automatically created scripts and manages them
*
	...
	*/
	public function __construct($parentId, $name, $content, $debug = false){
		...
		if($this->id == false){
			...
			IPS_SetInfo($this->id, "this script was created by script " . $_IPS['SELF'] . " which is part of the LightControl library");
		}
	}
